...
**`serving_config_spec_sha256`** / **`serving_config_state`** (0.122.0, ADR 0043) — the rendered llama-swap config's
provenance. These are **new keys on this existing endpoint**: no new route, no new bind, and every pre-0.122.0
