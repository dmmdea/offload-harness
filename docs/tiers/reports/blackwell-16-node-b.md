...
> (32614 MiB measured, `nvidia-smi` 2026-08-05). On **2026-08-31** a THIRD card (RTX 5060 Ti 16 GB) took it to **3× Blackwell 16 GB = 48.9 GB**, the shape `blackwell-3x16` covers — SHIPPED as a tier id in 0.113.32 and a COMPOSITE tier (ADR 0052) since 0.123.2. Kept verbatim as a point-in-time record.
