...
|---|---|---|---|
| [blackwell-16-<node-b>.md](blackwell-16-<node-b>.md) | <node-b> (RTX 5060 Ti 16 GB, Win 11) — **HISTORICAL, 2026-07-27** | `blackwell-16` | full ComfyUI stack; 11/11 media routes CONFIGURED. ⚠️ <node-b> gained a second card (RTX 5070 Ti 16 GB) on **2026-08-02** and now runs **`blackwell-2x16`, ~32 GB total VRAM**. This report predates that and is kept as a point-in-time record — do NOT read it as <node-b>'s current hardware. |
| [ampere-8-<node-a>.md](ampere-8-<node-a>.md) | <node-a> (RTX 3070 8 GB, Win 11) | `ampere-8` | after binding `voicegen_script`; render tree co-located with the binary |
| [ampere-6-<node-c>.md](ampere-6-<node-c>.md) | <node-c> (RTX 3050 6 GB, Ubuntu) | `ampere-6` | Linux node; `sdcpp` image engine, ComfyUI bound |
