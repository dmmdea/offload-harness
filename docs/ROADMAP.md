...
| **Lenovo M720q** | `ampere-16` — **NVIDIA A2 16GB** since 2026-09-04 (was `ampere-6` / RTX 3050 6GB), 64 GB RAM, Ubuntu; Coral Edge TPU on M.2 | fleet node, vLLM agent seat `qwen3.5-4b-vllm` (loads on use, `ttl: 300` — NOT boot-persistent since 0.113.36); LMCache L2 store |
