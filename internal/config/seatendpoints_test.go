	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.wantErr == "" {
				...
				if got := c.SeatEndpoints["lenovo-e4b"]; got != "http://lenovo-m720q:11436" {
