...
func TestAllHandlersSurfaceBadArguments(t *testing.T) {
	...
	cases := []struct {
		...
		{"generate_image family", s.handleGenerateImage, `{"prompt":"p","family":["qwen-image-2.1"]}`},
		{"generate_image transparent", s.handleGenerateImage, `{"prompt":"p","transparent":"yes"}`},
		{"edit_image_generative", s.handleEditImageGenerative, `{"image":"a.png","prompt":"p","steps":"many"}`},
		{"edit_image_generative images", s.handleEditImageGenerative, `{"image":"a.png","prompt":"p","images":"b.png"}`},
