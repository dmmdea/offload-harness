...
if ($macro -match '--cache-ram 16384')                         { Ok 'ampere-8/mid cache-ram 16384 (ADR 0055, never below llama-server's 8192 default)' } else { Bad "ampere-8/mid cache-ram (got: $macro)" }
