...
| `opus_output_price_per_mtok` | `75.0` | Price used to value the tokens a local seat GENERATED. Output bills at 5x input on Opus; before 0.117.4 the ledger priced it at zero. |
