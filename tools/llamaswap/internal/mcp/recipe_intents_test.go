...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	result, err := handleFreeVramSafelyBeforeARenderJob(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesParams(t *testing.T) {
	...
	if strings.Contains(got, "--all") {
		t.Fatalf("boolean false override should suppress --all: %q", got)
	}
	if strings.Contains(got, "--drain") {
		t.Fatalf("boolean false override should suppress --drain: %q", got)
	}
}
