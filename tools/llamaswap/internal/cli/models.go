...
func newModelsCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "models",
		Short:       "The configured roster and live swap state.",
	...
	cmd.AddCommand(newModelsRunningCmd(flags))
	cmd.AddCommand(newModelsUnloadCmd(flags))
	cmd.AddCommand(newModelsUnloadAllCmd(flags))
	return cmd
}
