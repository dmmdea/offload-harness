...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"llamaswap-pp-cli auth login",
		"llamaswap-pp-cli doctor",
		"llamaswap-pp-cli help items",
		"llamaswap-pp-cli sync",
		"llamaswap-pp-cli profile list",
		"llamaswap-pp-cli feedback list",
		"llamaswap-pp-cli which",
		"llamaswap-pp-cli agent-context",
		"llamaswap-pp-cli completion bash",
		"llamaswap-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"llamaswap-pp-cli recall",
		"llamaswap-pp-cli learnings",
		"llamaswap-pp-cli teach-pattern",
		"llamaswap-pp-cli teach-lookup",
		"llamaswap-pp-cli items list",
	}
