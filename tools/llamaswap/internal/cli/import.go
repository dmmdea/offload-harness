...
but do not stop the import.`,
  ...
  llamaswap-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  llamaswap-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | llamaswap-pp-cli import <resource> --input -`,
