...
but do not stop the import.`,
  ...
  comfyui-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  comfyui-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | comfyui-pp-cli import <resource> --input -`,
