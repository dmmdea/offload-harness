...
func newViewPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagSubfolder != "" {
				params["subfolder"] = formatCLIParamValue(flagSubfolder)
			}
			if flagType != "" {
	...
	cmd.Flags().StringVar(&flagSubfolder, "subfolder", "", "")
	cmd.Flags().StringVar(&flagType, "type", "", "output | input | temp")
