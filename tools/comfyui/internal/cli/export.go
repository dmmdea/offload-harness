...
large datasets as it has no memory pressure.`,
  ...
  comfyui-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  comfyui-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  comfyui-pp-cli export <resource> --format jsonl | jq '.id'`,
