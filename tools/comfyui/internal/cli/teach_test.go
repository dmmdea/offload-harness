...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"comfyui-pp-cli auth login",
		"comfyui-pp-cli doctor",
		"comfyui-pp-cli help items",
		"comfyui-pp-cli sync",
		"comfyui-pp-cli profile list",
		"comfyui-pp-cli feedback list",
		"comfyui-pp-cli which",
		"comfyui-pp-cli agent-context",
		"comfyui-pp-cli completion bash",
		"comfyui-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"comfyui-pp-cli recall",
		"comfyui-pp-cli learnings",
		"comfyui-pp-cli teach-pattern",
		"comfyui-pp-cli teach-lookup",
		"comfyui-pp-cli items list",
	}
