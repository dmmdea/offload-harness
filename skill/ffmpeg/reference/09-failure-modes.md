...
| 28 | ffmpeg ran, output present, but the wrong ffmpeg [measured path facts] | workstation has 8.1.2 on PATH and 9.0.1 in `<dev root>\tools` (harness lane) | print `ffmpeg -version` in logs; pin the path in scripts |
