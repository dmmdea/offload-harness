...
run live on the workstation (ffmpeg 8.1.2 Gyan full build) and the edge node (ffmpeg 8.0.1 Ubuntu) on
...
| `live-dump-2026-09-01.json` (8.1.2), `live-dump-edge-node-2026-09-01.json` (8.0.1), `live-dump-editing-rig-2026-09-10.json` (9.0) | exact encoder/decoder/filter/format availability, hwaccels, NVENC option enums per host. Regenerate any host with `ffdump.py` |
...
7. **Real-footage CQ points (MyTools DJI clip, VMAF vs near-lossless reference): hevc_nvenc cq 26–28 ≈ 10 Mbps at VMAF 99.8–99.6, av1_nvenc cq 34 ≈ 7.5 Mbps at 99.7, h264_nvenc cq 23 ≈ 20 Mbps at 99.9, libx264 crf 23 ≈ 9.7 Mbps at 99.1; p7+multipass gained nothing over p6.** NVENC quality knobs that matter: `-preset p1…p7` (p4 default, p7 slowest/best), `-tune hq`, `-rc vbr -cq N -b:v 0` for constant quality, `-multipass fullres -rc-lookahead 32 -spatial-aq 1 -temporal-aq 1 -b_ref_mode middle` for the "p7 delivery" profile. Measured 1080p on the workstation: h264 p4 372 fps, p7 195 fps; hevc p4 306 fps, p7 102 fps; av1 p4 365 fps. `av1_nvenc` does not exist on the RTX 3050 (edge node). **[measured]**
